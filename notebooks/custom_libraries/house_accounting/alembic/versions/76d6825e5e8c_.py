...
def upgrade():
    ...
    with op.batch_alter_table('cashflows', schema=None) as batch_op:
        ...
        batch_op.create_foreign_key(batch_op.f('fk_cashflows_time_category_id_time_categories'), 'time_categories', ['time_category_id'], ['id'])

    with op.batch_alter_table('main_categories', schema=None) as batch_op:
        batch_op.create_unique_constraint(batch_op.f('uq_main_categories_category'), ['category'])

    with op.batch_alter_table('sub_categories', schema=None) as batch_op:
        batch_op.create_unique_constraint(batch_op.f('uq_sub_categories_category'), ['category'])
...
def downgrade():
    ...
    with op.batch_alter_table('sub_categories', schema=None) as batch_op:
        batch_op.drop_constraint(batch_op.f('uq_sub_categories_category'), type_='unique')

    with op.batch_alter_table('main_categories', schema=None) as batch_op:
        batch_op.drop_constraint(batch_op.f('uq_main_categories_category'), type_='unique')

    with op.batch_alter_table('cashflows', schema=None) as batch_op:
        batch_op.drop_constraint(batch_op.f('fk_cashflows_time_category_id_time_categories'), type_='foreignkey')
